   							...
   							<div class="form-group">
   								 <label for="city">City:<p> </p></label>
      								<select id= "city"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" required>
       									<option value="Kathmandu" data-tokens="KTM Kathmandu">Kathmandu</option>
        								<option value="Pokhara" data-tokens="PKR Pokhara">Pokhara</option>
        								<option value="Lumbini" data-tokens="LMB Lumbini">Lumbini</option>
        								<option value="Mustang" data-tokens="MUS Mustang">Mustang</option>
        								<option value="Bhaktapur" data-tokens="BKT Bhaktapur">Bhaktapur</option>
        								<option value="Patan" data-tokens="PTN Patan">Patan</option>
      								</select>
							</div>
            			</div>
							...
							<div  class="col-sm-4">
								...
								<div class="listItem">
									...
									<div class="imageContainer text-center">
										...
										<img src="images/hotels/cities/NewDelhi/p1.jpeg" alt="New Delhi Hotels">
