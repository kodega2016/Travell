...
if(isset($_POST['but_submit'])){
    ...
    if ($username != "" && $password != ""){
        ...
        $sql_query = "SELECT password FROM `admins` WHERE username='".$username."'";
        ...
        if($row) {
            ...
            if(password_verify($password, $hashed_password)) {
                ...
                echo "<h4 class='text-center bg-danger' style='font-weight:bold;'>Invalid username or password</h4>";
            }
        } else {
            echo "<h4 class='text-center bg-danger' style='font-weight:bold;'>Invalid username or password</h4>";
        }
