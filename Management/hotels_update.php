  ...
  justify-content: center;">
			<div class="col-lg-4">
				...
				<form method="post" action="">
					...
					<input type="text" name="hotelID" class="form-control" placeholder="Hotel ID /Automatic Number Genrates" value="<?php echo ($hotelID); ?>">
...
<th>Image</th>
			...
			if ($result->num_rows > 0) {
				...
				while ($row = $result->fetch_assoc()) {
					...
					echo "<td>" . substr($row['hotelDesc'], 0, 100) . "...</td>";
					...
					echo "<td><img src='../" . $row['mainImage'] . "' width='150' height='140'></td>";
