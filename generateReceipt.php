			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<div class="info">
						...
						<span class="strong">1.</span> A printed copy of this booking information must be presented at the time of check-in.						
...
<?php
	...
	$bookingDataInsertSQL = $conn->prepare("INSERT INTO `hotelbookings` (hotelName, date, username, cancelled) VALUES('$hotelName','$dateFormatted','$user','no')");
